...
export const FaceToFaceDebriefSchema = z.object({
  overall_recommendation: z.enum([
    "Strong Hire",
    "Hire",
    "Lean Hire",
  ...
  scores: z.object({
    ...
    delivery:         DimensionSchema,
    body_language:    DimensionSchema,
  }),
  total_score: z.number().min(0).max(25),
  max_score: z.literal(25),
  strengths: z.array(z.string()).min(1),
...
export type FaceToFaceDebrief = z.infer<typeof FaceToFaceDebriefSchema>;

export type ConversationDebrief = BehavioralDebrief | RecruiterDebrief | FaceToFaceDebrief;
